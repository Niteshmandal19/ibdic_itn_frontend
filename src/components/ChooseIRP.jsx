...
const irpOptions = [
  { name: "CYGNET IRP", logo: "/path/to/cygnet-logo.png" },
  { name: "EY", logo: "/path/to/ey-logo.png" },
  { name: "NIC", logo: "/path/to/nic-logo.png" },
  { name: "IRIS IRP", logo: "/path/to/iris-logo.png" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <div className="flex gap-4">
        <button
          onClick={() => navigate("/eBL-generation")}
